...
Shared context for every skill in the `obsidian/` plugin. Skills should reference this file for vault concepts, Obsidian-native idioms, and the opinionated stance the plugin takes on best practices.
...
## The opinionated stance for this plugin
...
Patterns the plugin recommends:
...
## Anti-patterns the plugin names and discourages
...
## Influences this plugin leans on
